namespace CDK.DataAccess.Repositories.Mappings
{
    ...
    public class FoundationTypeMap : System.Data.Entity.ModelConfiguration.EntityTypeConfiguration<FoundationType>
    {
        public FoundationTypeMap()
            : this("ddf")
        {
        }

        public FoundationTypeMap(string schema)
        {
            ToTable(schema + ".FoundationType");
            HasKey(x => x.Id);
