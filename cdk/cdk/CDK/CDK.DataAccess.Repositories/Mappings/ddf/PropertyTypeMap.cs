namespace CDK.DataAccess.Repositories.Mappings
{
    ...
    public class PropertyTypeMap : System.Data.Entity.ModelConfiguration.EntityTypeConfiguration<PropertyType>
    {
        ...
        public PropertyTypeMap(string schema)
        {
            ToTable(schema + ".PropertyType");
            HasKey(x => x.Id);
