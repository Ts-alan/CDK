namespace CDK.DataAccess.Repositories.Mappings
{
    ...
    public class HeatingFuelMap : System.Data.Entity.ModelConfiguration.EntityTypeConfiguration<HeatingFuel>
    {
        public HeatingFuelMap()
            : this("ddf")
        {
        }

        public HeatingFuelMap(string schema)
        {
            ToTable(schema + ".HeatingFuel");
            HasKey(x => x.Id);
