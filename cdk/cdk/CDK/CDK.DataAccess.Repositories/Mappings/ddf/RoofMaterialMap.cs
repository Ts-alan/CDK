namespace CDK.DataAccess.Repositories.Mappings
{
    ...
    public class RoofMaterialMap : System.Data.Entity.ModelConfiguration.EntityTypeConfiguration<RoofMaterial>
    {
        public RoofMaterialMap()
            : this("ddf")
        {
        }

        public RoofMaterialMap(string schema)
        {
            ToTable(schema + ".RoofMaterial");
            HasKey(x => x.Id);
