namespace CDK.DataAccess.Repositories.Mappings
{
    ...
    public class SurfaceWaterMap : System.Data.Entity.ModelConfiguration.EntityTypeConfiguration<SurfaceWater>
    {
        public SurfaceWaterMap()
            : this("ddf")
        {
        }

        public SurfaceWaterMap(string schema)
        {
            ToTable(schema + ".SurfaceWater");
            HasKey(x => x.Id);
