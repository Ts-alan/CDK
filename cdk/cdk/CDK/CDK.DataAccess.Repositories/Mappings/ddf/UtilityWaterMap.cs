namespace CDK.DataAccess.Repositories.Mappings
{
    ...
    public class UtilityWaterMap : System.Data.Entity.ModelConfiguration.EntityTypeConfiguration<UtilityWater>
    {
        public UtilityWaterMap()
            : this("ddf")
        {
        }

        public UtilityWaterMap(string schema)
        {
            ToTable(schema + ".UtilityWater");
            HasKey(x => x.Id);
