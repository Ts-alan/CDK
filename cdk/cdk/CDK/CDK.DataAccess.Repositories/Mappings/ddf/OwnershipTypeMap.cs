namespace CDK.DataAccess.Repositories.Mappings
{
    ...
    public class OwnershipTypeMap : System.Data.Entity.ModelConfiguration.EntityTypeConfiguration<OwnershipType>
    {
        public OwnershipTypeMap()
            : this("ddf")
        {
        }

        public OwnershipTypeMap(string schema)
        {
            ToTable(schema + ".OwnershipType");
            HasKey(x => x.Id);
