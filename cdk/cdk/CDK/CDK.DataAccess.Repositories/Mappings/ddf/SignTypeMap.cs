namespace CDK.DataAccess.Repositories.Mappings
{
    ...
    public class SignTypeMap : System.Data.Entity.ModelConfiguration.EntityTypeConfiguration<SignType>
    {
        public SignTypeMap()
            : this("ddf")
        {
        ...
        public SignTypeMap(string schema)
        {
            ToTable(schema + ".SignType");
            HasKey(x => x.Id);
