namespace CDK.DataAccess.Repositories.Mappings
{
    ...
    public class PoolFeatureMap : System.Data.Entity.ModelConfiguration.EntityTypeConfiguration<PoolFeature>
    {
        public PoolFeatureMap()
            : this("ddf")
        {
        }

        public PoolFeatureMap(string schema)
        {
            ToTable(schema + ".PoolFeature");
            HasKey(x => x.Id);
