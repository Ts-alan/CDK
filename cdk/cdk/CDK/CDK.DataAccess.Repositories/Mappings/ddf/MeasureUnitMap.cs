namespace CDK.DataAccess.Repositories.Mappings
{
    ...
    public class MeasureUnitMap : System.Data.Entity.ModelConfiguration.EntityTypeConfiguration<MeasureUnit>
    {
        ...
        public MeasureUnitMap(string schema)
        {
            ToTable(schema + ".MeasureUnit");
            HasKey(x => x.Id);
