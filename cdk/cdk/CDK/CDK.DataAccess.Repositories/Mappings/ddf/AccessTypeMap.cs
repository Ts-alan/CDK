namespace CDK.DataAccess.Repositories.Mappings
{
    ...
    public class AccessTypeMap : System.Data.Entity.ModelConfiguration.EntityTypeConfiguration<AccessType>
    {
        ...
        public AccessTypeMap(string schema)
        {
            ToTable(schema + ".AccessType");
            HasKey(x => x.Id);
            ...
            HasMany(t => t.BuildingLands).WithMany(t => t.AccessTypes).Map(m =>
            {
                m.ToTable("LandAccessType", "ddf");
                m.MapLeftKey("AccessTypeId");
