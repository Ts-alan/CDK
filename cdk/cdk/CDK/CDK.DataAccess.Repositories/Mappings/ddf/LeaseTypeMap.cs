namespace CDK.DataAccess.Repositories.Mappings
{
    ...
    public class LeaseTypeMap : System.Data.Entity.ModelConfiguration.EntityTypeConfiguration<LeaseType>
    {
        public LeaseTypeMap()
            : this("ddf")
        {
        ...
        public LeaseTypeMap(string schema)
        {
            ToTable(schema + ".LeaseType");
            HasKey(x => x.Id);
