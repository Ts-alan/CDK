namespace CDK.DataAccess.Repositories.Mappings
{
    ...
    public class UffiCodeMap : System.Data.Entity.ModelConfiguration.EntityTypeConfiguration<UffiCode>
    {
        public UffiCodeMap()
            : this("ddf")
        {
        ...
        public UffiCodeMap(string schema)
        {
            ToTable(schema + ".UffiCode");
            HasKey(x => x.Id);
