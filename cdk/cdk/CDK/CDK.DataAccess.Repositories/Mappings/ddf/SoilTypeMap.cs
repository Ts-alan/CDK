namespace CDK.DataAccess.Repositories.Mappings
{
    ...
    public class SoilTypeMap : System.Data.Entity.ModelConfiguration.EntityTypeConfiguration<SoilType>
    {
        public SoilTypeMap()
            : this("ddf")
        {
        ...
        public SoilTypeMap(string schema)
        {
            ToTable(schema + ".SoilType");
            HasKey(x => x.Id);
