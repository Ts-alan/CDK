namespace CDK.DataAccess.Repositories.Mappings
{
    ...
    public class ConstructionStyleSplitLevelMap : System.Data.Entity.ModelConfiguration.EntityTypeConfiguration<ConstructionStyleSplitLevel>
    {
        public ConstructionStyleSplitLevelMap()
            : this("ddf")
        {
        }

        public ConstructionStyleSplitLevelMap(string schema)
        {
            ToTable(schema + ".ConstructionStyleSplitLevel");
            HasKey(x => x.Id);
