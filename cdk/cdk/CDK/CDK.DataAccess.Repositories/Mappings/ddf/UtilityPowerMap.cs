namespace CDK.DataAccess.Repositories.Mappings
{
    ...
    public class UtilityPowerMap : System.Data.Entity.ModelConfiguration.EntityTypeConfiguration<UtilityPower>
    {
        public UtilityPowerMap()
            : this("ddf")
        {
        }

        public UtilityPowerMap(string schema)
        {
            ToTable(schema + ".UtilityPower");
            HasKey(x => x.Id);
