namespace CDK.DataAccess.Repositories.Mappings
{
    ...
    public class WaterFrontTypeMap : System.Data.Entity.ModelConfiguration.EntityTypeConfiguration<WaterFrontType>
    {
        public WaterFrontTypeMap()
            : this("ddf")
        {
        }

        public WaterFrontTypeMap(string schema)
        {
            ToTable(schema + ".WaterFrontType");
            HasKey(x => x.Id);
