namespace CDK.DataAccess.Repositories.Mappings
{
    ...
    public class MachineryMap : System.Data.Entity.ModelConfiguration.EntityTypeConfiguration<Machinery>
    {
        public MachineryMap()
            : this("ddf")
        {
        ...
        public MachineryMap(string schema)
        {
            ToTable(schema + ".Machinery");
            HasKey(x => x.Id);
