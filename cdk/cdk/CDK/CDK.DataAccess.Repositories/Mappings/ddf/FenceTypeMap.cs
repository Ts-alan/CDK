namespace CDK.DataAccess.Repositories.Mappings
{
    ...
    public class FenceTypeMap : System.Data.Entity.ModelConfiguration.EntityTypeConfiguration<FenceType>
    {
        public FenceTypeMap()
            : this("ddf")
        {
        ...
        public FenceTypeMap(string schema)
        {
            ToTable(schema + ".FenceType");
            HasKey(x => x.Id);
