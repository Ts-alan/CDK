namespace CDK.DataAccess.Repositories.Mappings
{
    ...
    public class FireplaceFuelMap : System.Data.Entity.ModelConfiguration.EntityTypeConfiguration<FireplaceFuel>
    {
        public FireplaceFuelMap()
            : this("ddf")
        {
        }

        public FireplaceFuelMap(string schema)
        {
            ToTable(schema + ".FireplaceFuel");
            HasKey(x => x.Id);
