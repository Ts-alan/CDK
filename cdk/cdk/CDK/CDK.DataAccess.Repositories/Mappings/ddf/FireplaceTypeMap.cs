namespace CDK.DataAccess.Repositories.Mappings
{
    ...
    public class FireplaceTypeMap : System.Data.Entity.ModelConfiguration.EntityTypeConfiguration<FireplaceType>
    {
        public FireplaceTypeMap()
            : this("ddf")
        {
        }

        public FireplaceTypeMap(string schema)
        {
            ToTable(schema + ".FireplaceType");
            HasKey(x => x.Id);
