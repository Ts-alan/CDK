namespace CDK.DataAccess.Repositories.Mappings
{
    ...
    public class ConstructionStyleOtherMap : System.Data.Entity.ModelConfiguration.EntityTypeConfiguration<ConstructionStyleOther>
    {
        public ConstructionStyleOtherMap()
            : this("ddf")
        {
        }

        public ConstructionStyleOtherMap(string schema)
        {
            ToTable(schema + ".ConstructionStyleOther");
            HasKey(x => x.Id);
