namespace CDK.DataAccess.Repositories.Mappings
{
    ...
    public class ViewTypeMap : System.Data.Entity.ModelConfiguration.EntityTypeConfiguration<ViewType>
    {
        public ViewTypeMap()
            : this("ddf")
        {
        ...
        public ViewTypeMap(string schema)
        {
            ToTable(schema + ".ViewType");
            HasKey(x => x.Id);
