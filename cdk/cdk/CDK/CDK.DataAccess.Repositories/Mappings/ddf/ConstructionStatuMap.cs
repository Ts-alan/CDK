namespace CDK.DataAccess.Repositories.Mappings
{
    ...
    public class ConstructionStatuMap : System.Data.Entity.ModelConfiguration.EntityTypeConfiguration<ConstructionStatus>
    {
        public ConstructionStatuMap()
            : this("ddf")
        {
        }

        public ConstructionStatuMap(string schema)
        {
            ToTable(schema + ".ConstructionStatu");
            HasKey(x => x.Id);
