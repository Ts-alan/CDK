namespace CDK.DataAccess.Repositories.Mappings
{
    ...
    public class RoofStyleMap : System.Data.Entity.ModelConfiguration.EntityTypeConfiguration<RoofStyle>
    {
        public RoofStyleMap()
            : this("ddf")
        {
        ...
        public RoofStyleMap(string schema)
        {
            ToTable(schema + ".RoofStyle");
            HasKey(x => x.Id);
