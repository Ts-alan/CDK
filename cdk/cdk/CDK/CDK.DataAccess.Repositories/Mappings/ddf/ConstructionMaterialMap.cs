namespace CDK.DataAccess.Repositories.Mappings
{
    ...
    public class ConstructionMaterialMap : System.Data.Entity.ModelConfiguration.EntityTypeConfiguration<ConstructionMaterial>
    {
        public ConstructionMaterialMap()
            : this("ddf")
        {
        }

        public ConstructionMaterialMap(string schema)
        {
            ToTable(schema + ".ConstructionMaterial");
            HasKey(x => x.Id);
