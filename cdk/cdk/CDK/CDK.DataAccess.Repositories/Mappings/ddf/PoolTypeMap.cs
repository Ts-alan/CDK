namespace CDK.DataAccess.Repositories.Mappings
{
    ...
    public class PoolTypeMap : System.Data.Entity.ModelConfiguration.EntityTypeConfiguration<PoolType>
    {
        public PoolTypeMap()
            : this("ddf")
        {
        ...
        public PoolTypeMap(string schema)
        {
            ToTable(schema + ".PoolType");
            HasKey(x => x.Id);
