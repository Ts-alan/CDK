namespace CDK.DataAccess.Repositories.Mappings
{
    ...
    public class SoilEvaluationTypeMap : System.Data.Entity.ModelConfiguration.EntityTypeConfiguration<SoilEvaluationType>
    {
        public SoilEvaluationTypeMap()
            : this("ddf")
        {
        }

        public SoilEvaluationTypeMap(string schema)
        {
            ToTable(schema + ".SoilEvaluationType");
            HasKey(x => x.Id);
