namespace CDK.DataAccess.Repositories.Mappings
{
    ...
    public class EasementMap : System.Data.Entity.ModelConfiguration.EntityTypeConfiguration<Easement>
    {
        public EasementMap()
            : this("ddf")
        {
        ...
        public EasementMap(string schema)
        {
            ToTable(schema + ".Easement");
            HasKey(x => x.Id);
