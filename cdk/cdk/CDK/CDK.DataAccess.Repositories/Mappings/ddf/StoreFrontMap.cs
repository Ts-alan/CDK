namespace CDK.DataAccess.Repositories.Mappings
{
    ...
    public class StoreFrontMap : System.Data.Entity.ModelConfiguration.EntityTypeConfiguration<StoreFront>
    {
        public StoreFrontMap()
            : this("ddf")
        {
        }

        public StoreFrontMap(string schema)
        {
            ToTable(schema + ".StoreFront");
            HasKey(x => x.Id);
