namespace CDK.DataAccess.Repositories.Mappings
{
    ...
    public class FrontsOnMap : System.Data.Entity.ModelConfiguration.EntityTypeConfiguration<FrontsOn>
    {
        public FrontsOnMap()
            : this("ddf")
        {
        ...
        public FrontsOnMap(string schema)
        {
            ToTable(schema + ".FrontsOn");
            HasKey(x => x.Id);
