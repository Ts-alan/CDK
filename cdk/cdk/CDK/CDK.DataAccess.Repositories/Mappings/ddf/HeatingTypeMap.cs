namespace CDK.DataAccess.Repositories.Mappings
{
    ...
    public class HeatingTypeMap : System.Data.Entity.ModelConfiguration.EntityTypeConfiguration<HeatingType>
    {
        ...
        public HeatingTypeMap(string schema)
        {
            ToTable(schema + ".HeatingType");
            HasKey(x => x.Id);
