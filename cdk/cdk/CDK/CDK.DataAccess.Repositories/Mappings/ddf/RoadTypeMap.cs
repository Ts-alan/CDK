namespace CDK.DataAccess.Repositories.Mappings
{
    ...
    public class RoadTypeMap : System.Data.Entity.ModelConfiguration.EntityTypeConfiguration<RoadType>
    {
        public RoadTypeMap()
            : this("ddf")
        {
        ...
        public RoadTypeMap(string schema)
        {
            ToTable(schema + ".RoadType");
            HasKey(x => x.Id);
