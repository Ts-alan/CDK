namespace CDK.DataAccess.Repositories.Mappings
{
    ...
    public class CeilingTypeMap : System.Data.Entity.ModelConfiguration.EntityTypeConfiguration<CeilingType>
    {
        public CeilingTypeMap()
            : this("ddf")
        {
        }

        public CeilingTypeMap(string schema)
        {
            ToTable(schema + ".CeilingType");
            HasKey(x => x.Id);
