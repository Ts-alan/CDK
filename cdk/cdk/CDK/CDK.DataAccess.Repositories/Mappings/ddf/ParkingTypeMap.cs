namespace CDK.DataAccess.Repositories.Mappings
{
    ...
    public class ParkingTypeMap : System.Data.Entity.ModelConfiguration.EntityTypeConfiguration<ParkingType>
    {
        public ParkingTypeMap()
            : this("ddf")
        {
        }

        public ParkingTypeMap(string schema)
        {
            ToTable(schema + ".ParkingType");
            HasKey(x => x.Id);
