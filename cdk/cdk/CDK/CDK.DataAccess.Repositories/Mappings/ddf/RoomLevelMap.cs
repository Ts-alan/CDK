namespace CDK.DataAccess.Repositories.Mappings
{
    ...
    public class RoomLevelMap : System.Data.Entity.ModelConfiguration.EntityTypeConfiguration<RoomLevel>
    {
        public RoomLevelMap()
            : this("ddf")
        {
        ...
        public RoomLevelMap(string schema)
        {
            ToTable(schema + ".RoomLevel");
            HasKey(x => x.Id);
