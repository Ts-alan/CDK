namespace CDK.DataAccess.Repositories.Mappings
{
    ...
    public class CurrentUseMap : System.Data.Entity.ModelConfiguration.EntityTypeConfiguration<CurrentUse>
    {
        public CurrentUseMap()
            : this("ddf")
        {
        }

        public CurrentUseMap(string schema)
        {
            ToTable(schema + ".CurrentUse");
            HasKey(x => x.Id);
