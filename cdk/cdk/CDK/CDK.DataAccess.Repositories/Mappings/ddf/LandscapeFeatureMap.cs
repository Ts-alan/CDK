namespace CDK.DataAccess.Repositories.Mappings
{
    ...
    public class LandscapeFeatureMap : System.Data.Entity.ModelConfiguration.EntityTypeConfiguration<LandscapeFeature>
    {
        public LandscapeFeatureMap()
            : this("ddf")
        {
        }

        public LandscapeFeatureMap(string schema)
        {
            ToTable(schema + ".LandscapeFeature");
            HasKey(x => x.Id);
