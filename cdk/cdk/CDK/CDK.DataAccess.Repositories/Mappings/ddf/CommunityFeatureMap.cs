namespace CDK.DataAccess.Repositories.Mappings
{
    ...
    public class CommunityFeatureMap : System.Data.Entity.ModelConfiguration.EntityTypeConfiguration<CommunityFeature>
    {
        public CommunityFeatureMap()
            : this("ddf")
        {
        }

        public CommunityFeatureMap(string schema)
        {
            ToTable(schema + ".CommunityFeature");
            HasKey(x => x.Id);
