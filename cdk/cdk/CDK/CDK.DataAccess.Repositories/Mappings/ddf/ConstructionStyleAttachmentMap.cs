namespace CDK.DataAccess.Repositories.Mappings
{
    ...
    public class ConstructionStyleAttachmentMap : System.Data.Entity.ModelConfiguration.EntityTypeConfiguration<ConstructionStyleAttachment>
    {
        public ConstructionStyleAttachmentMap()
            : this("ddf")
        {
        }

        public ConstructionStyleAttachmentMap(string schema)
        {
            ToTable(schema + ".ConstructionStyleAttachment");
            HasKey(x => x.Id);
