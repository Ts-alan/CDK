namespace CDK.DataAccess.Repositories.Mappings
{
    ...
    public class ClearCeilingHeightMap : System.Data.Entity.ModelConfiguration.EntityTypeConfiguration<ClearCeilingHeight>
    {
        public ClearCeilingHeightMap()
            : this("ddf")
        {
        }

        public ClearCeilingHeightMap(string schema)
        {
            ToTable(schema + ".ClearCeilingHeight");
            HasKey(x => x.Id);
