...
namespace CDK.BusinessLogic.Core.ApplicationServices.Providers
{
    public class CDKOAuthProvider : OAuthAuthorizationServerProvider
    {
        private readonly string _publicClientId;

        public CDKOAuthProvider(string publicClientId)
        {
        ...
        {
            var userManager = context.OwinContext.GetUserManager<CDKUserManager>();
