...
namespace CDK.ETL.Core.Managers
{
    public class BlobManager
    {
        ...
        {
            cloudBlobContainer = SetUpContainer(connectionString, containerName);
        ...
        /// </summary>
        private CloudBlobContainer SetUpContainer(string connectionString, string containerName)
        {
        ...
        public void RunAtAppStartup(string connectionString, string containerName)
        {
            CloudBlobContainer startCloudBlobContainer = SetUpContainer(connectionString, containerName);
        ...
        public string UploadFromFile(string localFilePath)
        {
        ...
        public string DownloadFile(string blobName, string downloadFolder)
        {
            string status = string.Empty;
        ...
        public string RenameBlob(string blobName, string newBlobName)
        {
            string status = string.Empty;
